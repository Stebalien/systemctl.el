...
This package implements two commands from the =loginctl(1)= shell command for locking/unlocking sessions. They don't precisely belong in a ~systemctl~ package but they're useful enough to include.
